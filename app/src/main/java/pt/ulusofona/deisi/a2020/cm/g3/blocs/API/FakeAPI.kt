...
class FakeAPI {
    companion object {
        ...
        fun fakeData() : Data {
            return Data("2021-03-31", "2021-03-30", 624, 400000, 100000,100000, 200000, 200000, 100000, 200000, 230, 843, 15, 537, 10, 10, 10, 200, 200, 100, 100, 30, 20, 55, 100, 150, 165, 75, 55, 28, 30, 10, 10)
        }
